...
const featuredIds = ['patios', 'gardens', 'fire-pits-fireplaces', 'outdoor-kitchens-countertops', 'water-features', 'pool-decks']
    ...
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            ...
            <p className="text-stone-gray font-body leading-relaxed mb-8 text-sm">
              We believe the space behind your home is as important as the space inside it. Stonefield Landscaping
              specializes in creating residential landscapes that are as functional as they are beautiful — outdoor
              living areas you&apos;ll actually live in, gardens that thrive across Manitoba&apos;s four seasons, and
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 w-28 h-28 bg-gold hidden md:flex flex-col items-center justify-center text-white text-center p-4">
              <span className="font-display text-3xl font-semibold leading-none">25+</span>
              <span className="text-[9px] tracking-wide font-body uppercase mt-1">Years of Excellence</span>
            </div>
          </div>
        </div>
      </SectionWrapper>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-white/65 font-body leading-relaxed mb-8 text-sm">
              From corporate campuses and multi-family developments to retail environments and public spaces, Stonefield
              delivers commercial landscape solutions that elevate your property&apos;s presence and value. We
              understand the unique demands of commercial projects — scale, durability, and ongoing maintenance.
            </p>
            <Link
      ...
      <SectionWrapper className="bg-stone-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <p className="text-gold text-[10px] tracking-[0.35em] uppercase font-body font-medium mb-4">Transparent Pricing</p>
            <h2 className="font-display text-4xl md:text-5xl font-light text-green-deep leading-tight mb-6">
              Understand Your Investment
            </h2>
            <p className="text-stone-gray font-body leading-relaxed mb-8 text-sm">
              We believe in honest conversations about cost from the very beginning. Our pricing page gives you a
              realistic framework for landscape budgets in Winnipeg — so you can approach our consultation with
              confidence.
            </p>
            <Link
      ...
      <SectionWrapper className="bg-charcoal">
        <div className="text-center mb-14">
          <p className="text-gold text-[10px] tracking-[0.35em] uppercase font-body font-medium mb-4">Our Work</p>
          <h2 className="font-display text-4xl md:text-5xl font-light text-white">Featured Projects</h2>
        </div>
      ...
      <SectionWrapper className="bg-stone-warm">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-stone-gray font-body text-sm leading-relaxed mb-8">
            From River Heights to Linden Woods, from Charleswood to St. Vital — we&apos;ve transformed outdoor spaces
            across every neighbourhood in Winnipeg and beyond. Our deep knowledge of Manitoba&apos;s soils, climate,
            and plant palette means every landscape we build is designed to endure.
          </p>
          <Link
            href="/consultation"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-green-deep text-white text-sm font-body font-medium tracking-wide hover:bg-green-mid transition-colors duration-200 rounded-lg"
