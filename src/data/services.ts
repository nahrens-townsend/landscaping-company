...
export const services: Service[] = [
  ...
  },
  {
    ...
    longDescription:
      'When the design is approved and the plan is set, our construction teams take over with the same dedication to quality that defines every Stonefield project. We manage all aspects of construction — grading, drainage, hardscaping, planting, and site cleanup — with a consistent crew foreman overseeing your project from start to finish.',
    iconName: 'HardHat',
